...
@onready var equipment: PanelContainer = $Equipment
...
func set_player_weapon_data(inventory_data: InventoryData) -> void:
	inventory_data.inventory_interact.connect(on_inventory_interact)
	weapon.set_inventory_data(inventory_data)
	
func set_player_equipment_data(inventory_data: InventoryData) -> void:
	inventory_data.inventory_interact.connect(on_inventory_interact)
	equipment.set_inventory_data(inventory_data)
